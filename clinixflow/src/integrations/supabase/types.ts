  ...
  public: {
    Tables: {
      ...
      insurance_guides: {
        ...
        Relationships: [
          {
            foreignKeyName: "insurance_guides_convention_id_fkey"
          ...
          {
            foreignKeyName: "insurance_guides_patient_id_fkey"
            columns: ["patient_id"]
            isOneToOne: false
            referencedRelation: "patients"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "insurance_guides_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
    ...
    Enums: {
      ...
      document_category:
        ...
        | "OTHER"
      financial_status: "PROJECTED" | "REALIZED" | "RECEIVED"
