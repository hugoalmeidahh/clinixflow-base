...
export enum ClinicSpecialty {
  ...
  FISIOTERAPIA = "Terapeuta Fisioterapia",
  PSICOLOGO = "Psicológo",
...
export const medicalSpecialties = Object.entries(ClinicSpecialty).map(
  ([key, value]) => ({
    value: ClinicSpecialty[key as keyof typeof ClinicSpecialty],
    label: value,
  }),
);
